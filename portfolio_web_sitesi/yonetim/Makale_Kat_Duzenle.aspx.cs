...
public partial class yonetim_Makale_Kat_Duzenle : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            kod.komut("delete from makaleKategori where makaleKategoriId=" + Request.QueryString["id"].ToString());
