<%@ Page Title="" Language="C#" MasterPageFile="~/yonetim/yonetim.master" AutoEventWireup="true" CodeFile="Yetenek_Guncelle.aspx.cs" Inherits="yonetim_Yetenek_Guncelle" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h2 class="text-center mb-3 p-2">Yetenek Düzenle</h2>
    <table class="table mx-auto" style="max-width:500px">
        ...
        <tr>
            <td colspan="2" class="text-center">
                ...
                <asp:Button ID="btnEkle" runat="server" Text="Yetenek Güncelle" CssClass="btn btn-success form-control w-50 " OnClick="btnEkle_Click"  />
            </td>
        </tr>
